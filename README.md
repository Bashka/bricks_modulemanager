# Bricks.ModuleManager

Пакет реализует механизм загрузки и инициализации модулей приложения.
...
[исходные коды]: https://github.com/Bashka/bricks_modulemanager/releases
[PHPUnit]: http://phpunit.de/
[обсуждение]: https://github.com/Bashka/bricks_modulemanager/issues
